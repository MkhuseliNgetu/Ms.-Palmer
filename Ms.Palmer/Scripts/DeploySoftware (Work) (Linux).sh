...
then
	...
	#Plots - for graph creation
	flatpak install -y --noninteractive flathub com.github.alexhuntley.Plots
	#FreeCAD - for 3D Editing
	...
	#Atmo.io
	flatpak install -y --noninteractive flathub io.atom.Atom
	#Netbeans
	flatpak install -y --noninteractive flathub org.apache.netbeans
